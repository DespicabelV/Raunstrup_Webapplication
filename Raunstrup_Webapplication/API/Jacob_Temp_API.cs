...
namespace Raunstrup_Webapplication.API
{
    ...
    [ApiController]
    public class Jacob_Temp_API : ControllerBase
    {
        private readonly ApplicationDbContext _context;

        public Jacob_Temp_API(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: api/Jacob_Temp_API
        [HttpGet]
