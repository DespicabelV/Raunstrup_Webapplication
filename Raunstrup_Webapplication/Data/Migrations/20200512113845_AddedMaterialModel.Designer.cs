...
namespace Raunstrup_Webapplication.Data.Migrations
{
    ...
    [Migration("20200512113845_AddedMaterialModel")]
    partial class AddedMaterialModel
    {
            ...
            modelBuilder.Entity("Raunstrup_Webapplication.Models.ResourceModel", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ResourceModel");
                });

            modelBuilder.Entity("Raunstrup_Webapplication.Models.MaterialModel", b =>
                {
                    b.HasBaseType("Raunstrup_Webapplication.Models.ResourceModel");
                    ...
                    b.HasDiscriminator().HasValue("MaterialModel");
                });
